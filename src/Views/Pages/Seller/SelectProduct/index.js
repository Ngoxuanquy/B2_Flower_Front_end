...
function Index() {
    ...
    const handerDelete = (productId) => {
        ...
        // Lấy dữ liệu của khách hàng
        fetch(URL + '/product/delete/' + productId, requestOptions).then(
            (data) => {
                                ...
                                apiproducts.map((api, index) => (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <td>
                                                {api.product_attributes.size}
                                            </td>
                                            <td>
                                                {api.product_attributes.color}
                                            </td>
                                            <td
                                                style={{
                                                    fontSize: '17px',
                ...
                <div className={cx('rigth')}>
                    <div className={cx('title')}>
                        ...
                        >
                            ...
                            >
                                Danh Sách Sản Phẩm chưa public lên cho người
                                dùng
                            </div>
                            <div style={{}}>
                                {isloadupdate == true ? (
