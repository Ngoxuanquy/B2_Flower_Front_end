...
const options = {
  scales: {
    x: {
      beginAtZero: true,
      ticks: {
        color: "blue", // Color for X-axis labels
      },
    },
    y: {
      beginAtZero: true,
  ...
  plugins: {
    legend: {
      labels: {
        color: "green", // Color for legend labels
      },
    },
    tooltip: {
      bodyColor: "red", // Color for tooltip body text
      titleColor: "orange", // Color for tooltip title
    },
    zoom: {
      pan: {
        enabled: true,
