...
export function handelDiscountO(
  cleanedJwtString,
  cleanId,
  textRadom,
  users,
...
const RegisteredUsers = ({ apis, fetchUsers }) => {
  ...
  const handleDiscountOk = () => {
    ...
    const validation = handelDiscountO(
      token,
      id,
      textRadom,
      users,
  ...
  return (
    <div className={cx("container")}>
      ...
      <h4 className={cx("titleRegistered")}>Người dùng đã đăng ký</h4>
      <div
        style={{
          display: "flex",
          ...
          <div className="col-md-3 " style={{ marginLeft: "10px" }}>
            ...
            >
              ...
              >
                ...
                <MenuItem value="DESTROYFLOWERS">Destroy Flowers</MenuItem>
              </Select>
            </FormControl>
          </div>
        </div>
